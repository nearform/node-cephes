...
export declare function polevl(x: number, coef: Float64Array, N: number): number;
export declare function chbevl(x: number, array: Float64Array, n: number): number;
...
export declare function frexp(x: number): readonly [number, {
    readonly pw2: number;
}];
...
export declare function sincos(x: number, flg: number): readonly [number, {
    readonly s: number;
    readonly c: number;
}];
...
export declare function shichi(x: number): readonly [number, {
    readonly si: number;
    readonly ci: number;
}];
export declare function sici(x: number): readonly [number, {
    readonly si: number;
    readonly ci: number;
}];
...
export declare function fresnl(xxa: number): readonly [number, {
    readonly ssa: number;
    readonly cca: number;
}];
export declare function airy(x: number): readonly [number, {
    readonly ai: number;
    readonly aip: number;
    readonly bi: number;
    readonly bip: number;
...
export declare function hyp2f1(a: number, b: number, c: number, x: number): number;
...
export declare function ellpj(u: number, m: number): readonly [number, {
    readonly sn: number;
    readonly cn: number;
    readonly dn: number;
    readonly ph: number;
