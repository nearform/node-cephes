 ...
 * SYNOPSIS:
 *
 * double ignore_ceil(), ignore_floor(), frexp(), ldexp();
 ...
 * result.
 *
 * ignore_floor() returns the largest integer less than or equal to x.
 * It truncates toward minus infinity.
 *
 * ignore_ceil() returns the smallest integer greater than or equal
...
#ifdef UNK
/* ignore_ceil(), ignore_floor(), frexp(), ldexp() may need to be rewritten. */
#undef UNK
#if BIGENDIAN
#define MIEEE 1
#else
